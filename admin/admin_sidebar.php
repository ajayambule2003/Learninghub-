     <div class="span3" id="sidebar">
                    ...
                    <!-- Meeting and Gaming model  -->
                        <li class="">
                            <a href="#"><i class="icon-chevron-right"></i><i class="icon-calendar"></i>Meeting</a>
                        </li>
                        <li class="">
                            <a href="#"><i class="icon-chevron-right"></i><i class="icon-calendar"></i>Intractive Learning</a>
                        </li>
                    </ul>
